...
describe "storing simple UUIDs as strings" do
...
describe "storing UUIDs with a natural key as strings" do
  include_examples "model with UUIDs and a natural key" do
    let(:model) { StringUuidArticleWithNaturalKey }
  end
end

describe "storing UUIDs with a namespace as strings" do
